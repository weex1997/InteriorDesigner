...
//    public func eventSourceRequest(_ convertible: URLConvertible, method: HTTPMethod = .get, parameters: OpenAIChatBody?, headers: HTTPHeaders? = nil, lastEventID: String? = nil) -> DataStreamRequest {
//        
//        return streamRequest(convertible, parameters: parameters)
//        return streamRequest(convertible, method: method, parameters: parameters, encoder: .json, headers: headers) { _ in
//            
//        }
