    ...
    var body: some View {
        NavigationView {
            ...
            VStack {
                ...
                //NavigationLink(destination: ChatLogView(vm: chatLogViewModel).navigationBarBackButtonHidden(false), isActive: $shouldNavigateToChatLogView){}
...
//            WebImage(url: URL(string: vm.chatUser?.profileImageUrl ?? ""))
            ...
            VStack(alignment: .leading, spacing: 4) {
                let email = vm.chatUser?.name?.replacingOccurrences(of: "@gmail.com", with: "") ?? ""
                Text(email)
